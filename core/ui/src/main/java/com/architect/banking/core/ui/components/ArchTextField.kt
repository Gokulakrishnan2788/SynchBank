        ...
        ArchTextFieldVariant.FILLED -> {
            TextField(
                ...
                colors = TextFieldDefaults.colors(
                    focusedContainerColor = ArchitectColors.LightGray,
                    unfocusedContainerColor = ArchitectColors.LightGray,
                    disabledContainerColor = ArchitectColors.LightGray,
                    errorContainerColor = ArchitectColors.LightGray,
