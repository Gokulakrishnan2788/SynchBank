        ...
        ArchTextFieldVariant.FILLED -> {
            TextField(
                ...
                colors = TextFieldDefaults.colors(
                    focusedContainerColor = ArchitectColors.FilledFieldBackground,
                    unfocusedContainerColor = ArchitectColors.FilledFieldBackground,
                    disabledContainerColor = ArchitectColors.FilledFieldBackground,
                    errorContainerColor = ArchitectColors.FilledFieldBackground,
